...
export const getRequiredSchema = (): RequiredTableSchema[] => [
  { name: 'users', columns: ['id', 'full_name', 'username', 'password_hash', 'role', 'status', 'access_to_panel', 'created_at', 'updated_at'] },
  ...
  { name: 'conversations', columns: ['id', 'agent_id', 'contact_id', 'topic', 'start_time'] },
  { name: 'messages', columns: ['id', 'conversation_id', 'sender', 'text', 'time', 'source', 'external_message_id', 'content_type', 'text_body', 'media_file_id', 'channel', 'created_at'] },
  { name: 'contacts', columns: ['id', 'agent_id', 'name', 'phone', 'company', 'position', 'created_at'] },
  { name: 'user_sessions', columns: ['id', 'auth_user_id', 'token_hash', 'expires_at', 'created_at', 'updated_at', 'revoked_at'] },
  { name: 'audit_logs', columns: ['id', 'entity_type', 'entity_id', 'action', 'performed_by', 'user_id', 'details', 'created_at'] },
